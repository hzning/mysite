...
class BindEmailForm(forms.Form):
    email = forms.EmailField(label="邮箱", required=False,
                                                         widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': '请正确的邮箱'}))
    verification_code = forms.CharField(label="验证码",
                                                         widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': '点击“发送验证码”发送到邮箱'}))
...
class ChangePasswordForm(forms.Form):
    old_password = forms.CharField(
        label="旧的密码",
        widget=forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': '请旧的输入密码'}))
...
class ForgotPasswordForm(forms.Form):
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': '请绑定过的邮箱'}))
